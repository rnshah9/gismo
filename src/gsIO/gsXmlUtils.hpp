...
/// Get a Matrix from XML data
template<>
class gsXml< char const *>
{
private:
    gsXml() { }
    typedef char const * Object;

public:
    GSXML_COMMON_FUNCTIONS(Object);
    static std::string tag () { return "String"; }
    static std::string type() { return ""; }
    ...
    static void get_into (gsXmlNode * node, Object & obj)
    {
        GISMO_ASSERT( !strcmp( node->name(),"String"),
                      "Something went wrong. Expected String tag." );

        // If there will be attributes
                            ...
                            gsXmlTree & data )
    {
        ...
        gsXmlNode * tmp = internal::makeNode("String", obj, data);
...
public:
                            ...
                            gsXmlTree & data )
    {
        ...
        // Make a new XML KnotVector node
        gsXmlNode * tmp = internal::makeNode("String", str.str(), data);
